...
router.put('/edit-company-account/:_id', auth,upload.single('imageUrl') , adminController.EDIT_COMPANY_ACCOUNT)
router.put('/edit-admin-account/:_id', auth,adminController.EDIT_ADMIN_ACCOUNT)
